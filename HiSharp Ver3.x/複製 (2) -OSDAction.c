...
//	printf("Command Shell for HiSharp Set S or J Mode");
	...
	switch(SYSMIXTYP) {
		...
		#ifdef TW2835_CLEAR_MODE_ICON  //Pinchi 20150410 add to clear Mode icon when change image
			PCT_ClearWordsPathX(0, LOCATE_YT0, 2);
		#endif
			if(iconid) {
			#ifndef TW2835_CLEAR_MODE_ICON  //Pinchi 20150410 add to clear Mode icon when change image
				PCT_ClearWordsPathX(0, LOCATE_YT0, 2);
			#endif
